        ...
        <div style={{ display:"flex",alignItems:"center",gap:"0.875rem" }}>
          ...
          <div>
            ...
            <div style={{ display:"flex",alignItems:"center",gap:"0.75rem",marginTop:"0.2rem",flexWrap:"wrap" }}>
              <span style={{ fontSize:"0.7rem",color:"var(--text3)" }}>slug: {tenant.slug}</span>
              <a href={`/login/${tenant.slug}`} target="_blank" rel="noreferrer"
                style={{ fontSize:"0.7rem",color:"var(--accent)",background:"var(--accent-bg)",padding:"0.15rem 0.5rem",borderRadius:"999px",textDecoration:"none",fontWeight:600 }}>
                🔗 /login/{tenant.slug}
              </a>
            </div>
          </div>
