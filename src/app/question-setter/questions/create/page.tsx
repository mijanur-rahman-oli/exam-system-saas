...
export default function AdminCreateQuestionPage() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess:()=>{toast({title:"Question saved!"});router.push("/question-setter/questions");},
    ...
    <div style={{display:"flex",flexDirection:"column",gap:"1.5rem"}}>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:"0.875rem"}}>
          <Link href="/question-setter/questions"><button style={{background:"none",border:"none",cursor:"pointer",color:"var(--text2)",display:"flex",padding:"0.25rem"}}><ArrowLeft size={18}/></button></Link>
